...
class ItemServiceTest {
    ...
    public void 제품_저장() throws Exception {
        ...
        //then
        assertEquals(item.getModelNumber(),itemRepository.findById(saveItemId).getModelNumber());
    }
    ...
    public void 제품명으로_검색() throws Exception {
        ...
        //when
        List<SearchItemDto> findItems1 = itemService.findAllByModelNumber("부엉이");
        List<SearchItemDto> findItems2 = itemService.findAllByModelNumber("");
